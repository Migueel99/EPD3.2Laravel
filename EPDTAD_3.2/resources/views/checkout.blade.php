...
<head>
    ...
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.15.4/css/all.css%22%3E">
</head>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 col-lg-2 col-md-1 mb-2">
                                    <h6 class="text-1000">{{ $producto->producto->nombre }}</h6>
                                </div>
                                <div class="col-4 col-lg-3 col-md-1 mb-2 ">
                                    <p class="text-1000">Cantidad: {{ $producto->cantidad }}</p>
                                </div>
                                <div class="col-4 col-lg-2 col-md-1 mb-2">
                                    <p class="text-1000">Precio: {{ $producto->producto->precio * $producto->cantidad }}</p>
                                </div>
                            </div>
                            <hr>
                            @endforeach
                            ...
                            <div class="card-footer align-content-center">
                                <a href="{{ route('pagar') }}" class="btn btn-primary btn-fill text-primary btn-block">{{ __('Checkout') }}</a>
                                <hr>
