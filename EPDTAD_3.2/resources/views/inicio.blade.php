...
<body>
    ...
    <main class="main" id="top">
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" data-navbar-on-scroll="data-navbar-on-scroll">
            <div class="container"><a class="navbar-brand d-inline-flex" href="index.html"><span class="text-1000 fs-3 fw-bold ms-2 text-gradient">MiniatureCars</span></a>
                ...
                @guest
                <a class="btn btn-white shadow-warning text-warning" href="{{ route('login') }}"> <i class="fas fa-user me-2"></i>{{ __('Login') }}</a>
                @else
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-3 col-xl mb-5 h-100">
                                <div class="card card-span h-100 rounded-3">
                                    <img class="card-img-top " src="{{ asset('img/productos/' . $producto->imagen) }}" onclick="mostrarPopup(this);">
