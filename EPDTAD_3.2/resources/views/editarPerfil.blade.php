...
<body>
    ...
    <div class="container-fluid ">
        ...
        <div class="row justify-content-md-center pb-5">
            <div class="card-wrapper col-12 col-md-4 mt-6">
                <div class="brand text-center mb-3">
                    ...
                    <h1 class="text-1000  fw-bold  text-gradient">{{ __('Editar Perfil') }}</h1>
                    <div class="card" style="border-radius: 15px;">

                        <form method="POST" action="{{ route('users.update', Auth::user()->id) }}" role="form"
                            enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            @csrf

                            <label class="block text-sm mt-2">
                                <span class="text-gray-700  dark:text-gray-400">{{ Form::label(__('Nombre')) }}:</span>
                                ...
                                <tr>
                                    <td>
                                        <div class="box-footer mt20">
                                            <input type="submit" class="btn btn-danger " value="{{ __('Editar') }}">
                                        </div>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>
            ...
            <div class="row mt-3 ">
                ...
                <div class="col-sm-12 col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                    ...
                    <p style="color: white;"><a href="img\descargas\CondicionesMiniatureCars.pdf"
                            download="CondicionesMiniatureCars.pdf"
                            class="text-reset">{{ __('Términos y condiciones') }}</a>
                    </p>
