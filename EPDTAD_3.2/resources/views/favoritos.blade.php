            ...
            <div class="card-wrapper col-12 col-md-4 mt-5">
                <div class="brand text-center mb-3">
                    <a class="navbar-brand d-inline-flex" href="{{ route('inicio') }}">
                        <h1 class="text-1000  fw-bold  text-gradient">{{ __('Productos favoritos') }}</h1>
                    </a>
                    <div class="card">
                        <div class="card-body">
                            @if (Auth::user()->favoritos->count() > 0)
                                @foreach (Auth::user()->favoritos as $producto)
                                    <div class="row">
                                        <div class="col-3">
                                            <img src="{{ asset('img/productos/' . $producto->productos->imagen) }}"
                                                alt="imagen" class="img-fluid">
                                        </div>
                                        <div class="col-3">
                                            <h6 class="text-700">{{ $producto->productos->nombre }}</h6>
                                        </div>
                                    </div>
                                    <hr>
                                @endforeach
                    ...
                    @else
                        <h2>{{ __('No hay productos en la lista de favoritos') }}</h2>
                        @endif
                    </div>
